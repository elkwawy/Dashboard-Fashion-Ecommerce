  ...
  async ({ product }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        "https://ecommerce-dot-code.vercel.app/api/product",
        formData,
        {
          headers: {
            Authorization: token,
      ...
      return rejectWithValue(
        error.response?.data || error.message || "Error adding product"
      );
    }
  }
);
  ...
  async ({ id, product }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put(
        `https://ecommerce-dot-code.vercel.app/api/product/${id}`,
        formData,
        {
          headers: {
            Authorization: token,
