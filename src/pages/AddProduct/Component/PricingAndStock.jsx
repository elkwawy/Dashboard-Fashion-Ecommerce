  ...
  <div className=' border-2 border-gray-300 rounded-lg p-4 mb-6'>
    ...
    <div className=' grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='flex flex-col items-start justify-center gap-2' >
           ...
           <input type="text" name='price' placeholder='$...' className='w-full px-2 py-1 border border-gray-300 rounded' onChange={handelPrice}/>
        </div>
        {/* stock */}
        <div className='flex flex-col items-start justify-center gap-2'>
            <label htmlFor='stock'>Stock</label>
           <input type="text" name='stock' placeholder='Enter number of stock...' className= 'w-full px-2 py-1 border border-gray-300 rounded' onChange={handelStock}/>
        </div>
        {/* discount */}
        <div className='flex flex-col items-start justify-center gap-2'>
