...
const RootLayout = memo((auth) => {
    ...
    return (
        <div className="w-full flex h-screen overflow-hidden">
            <Suspense fallback={<div className='h-full flex items-center justify-center w-full min-[700px]:w-[32%] lg:w-1/4 xl:w-1/6'><Loader /></div>}>
                <Sidebar
                    sidebar={sidebar}
            ...
            <div className="flex w-full flex-col">
                ...
                <div className="flex flex-col gap-5 w-full pt-5 h-screen bg-background-color overflow-y-auto openPageDiv">
                    <Suspense fallback={<div className='w-44 h-2 bg-gray-100 trans animate-pulse'></div>}>
                        <PathTracker  />
                    </Suspense>
