        ...
        <div className="md:flex space-y-4 md:space-y-0 items-center justify-between bg-white">
          <div className="relative md:w-[300px] lg:w-[450px] w-full mr-4">
            <input
              ...
              className="w-full p-2 inputD rounded-md"
            />
                ...
                <tbody className="divide-y relative divide-gray-[#D5D5D5]">
                  {loading ? (
                    ...
                    filteredCategories.map((cat) => (
                      <tr key={cat._id}>
                        <td className="px-2 ml-2 block py-3 text-sm font-medium text-black whitespace-nowrap">
                          <img
                            src={
                              cat.image ||
                              "/shop-clothing-clothes-shop-hanger-modern-shop-boutique.jpg"
                            }
                            alt={cat.name}
                            className="min-w-14 w-14 h-14 min-h-14 rounded-md"
                          />
                        </td>
