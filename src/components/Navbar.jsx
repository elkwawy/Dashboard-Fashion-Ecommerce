...
import logo from "../assets/logo.webp";<div className="w-8 h-8 bg-gray-300 rounded-full " />
    ...
    return (
        <div className="w-full border-b-2 px-5 py-2 flex justify-between items-center">
            <div className="flex gap-3 items-start">
                ...
                <Link to={'/dashboard'} className={`outline-0 max-[260px]:text-2xl text-3xl font-bold ${sidebar ? "-translate-x-[52px]" : " -translate-x-2 "} transition-all duration-500`}>
            ...
            <div className="flex items-center max-[700px]:gap-2 gap-5 -mr-2">
                ...
                <div className="flex  gap-1 p-1 rounded-md trans hover:bg-gray-100 cursor-pointer items-center">
                    ...
                    {status === "loading" && !user && !user?.name && <span className="h-4 w-28 bg-gray-100 animate-pulse max-[700px]:hidden"></span>}
